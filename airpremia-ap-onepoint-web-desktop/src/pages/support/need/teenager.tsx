      ...
      <C.wrap>
        <C.body>
                ...
                <table>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td></td>
                      <td>에어프레미아에서 별도로 정한 성인운임<br />+서비스 구간당(인당/편도) 100,000 KRW</td>
                    </tr>
                  </tbody>
                  <tbody>
                    <tr>
          ...
          <C.sbody>
            ...
            <C.ul>
              <C.li><C.bold>1) 출발지:</C.bold> 담당직원이 출구수속 및 탑승을 도와드리며 해당 항공편 객실  승무원에게 인계합니다.</C.li>
              <C.li><C.bold>2) 기내:</C.bold> 객실승무원들이 비행 중 어린이를 보살펴 드립니다.</C.li>
              <C.li><C.bold>3) 도착지:</C.bold> 담당직원이 객실승무원으로부터 인계를 받고 수하물 수취와 입국 수속을 도와드립니다. 그 후, 도착지 보호자에게 인계합니다.</C.li>
            </C.ul>
          </C.sbody>
          <C.sbody>
            <C.subTitle>서비스 신청 방법</C.subTitle>
            <C.ul>
              <C.li><C.bold>1) 비동반 소아 서비스 신청:</C.bold> 항공기 출발 48시간 전까지 예약센터(02-6953-6115)로 서비스를 신청하신 후 확약을 받으시기  바랍니다.</C.li>
              <C.li>2) 신청서를 다운받아 작성하여 지참해주시기 바랍니다.</C.li>
              <C.li>
                <C.linkm>
                  <a href="/document/support_need-teenager_01.pdf" download>
              ...
              <C.li>
                <C.linkm>
                  <a href="/document/support_need-teenager_02.pdf" download>
                  보호자 서약서 다운<Linkblue />
                  </a>
                </C.linkm>
              </C.li>
          ...
          <C.sbody>
            <C.content>
              ...
              <C.description>- 출발할 때와 도착할 때는 반드시 보호자(만 18세 이상)의 인수인계가 필요합니다.</C.description>
              <C.description>- 어린이의 안전을 위하여 환승시간은 6시간 이내인 경우 가능합니다. </C.description>
              <C.description>- 회사가 직접 운항하는 구간만 이용 가능하며, 타사로 연결되는 항​공편의 경우 접수 불가합니다.</C.description>
              <C.description>- 항공기 출발 48시간 전 예약없이 출발 당일 신청 시에는 여행이 불가할 수도 있습니다.</C.description>
              <C.description>- 필요한 비동반 소아 서류(비동반 소아 서비스 신청서, 보호자 서약서)는 사전에 작성하시어 출발 당일 공항 카운터에 제출​하셔야 하며, 구비 여부에 따라 서비스가 제공되지 않을수도 있습니다.</C.description>
            </C.content>
          </C.sbody>
        </C.body>
      </C.wrap>
