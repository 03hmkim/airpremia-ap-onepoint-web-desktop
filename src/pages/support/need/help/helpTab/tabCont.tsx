      ...
      case 'helpModal':
        return (
          <NewModal
            ...
            title={
              <S.modalTitle>
                <PopupTitle><p>기내 사용 가능한 <br /> 휴대용 산소 발생기 모델명</p></PopupTitle>
              </S.modalTitle>
            }
            body={
              <>
  ...
  if ( currIdxCont === 0 ) {
    ...
    return (
      <C.wrap className="bdN">
        ...
        <C.body>
          <C.titleSub>휠체어 대여 서비스</C.titleSub>
          <C.content>
            <ListGlobal level="fst" body={
        ...
        <C.body>
          <C.titleSub>본인 휠체어 이용 손님</C.titleSub>
          <C.content>
            <ListGlobal level="fst" body={
        ...
        <C.body>
          <C.titleSub>기내 휠체어 이용 손님</C.titleSub>
          <C.content>
            <ListGlobal level="fst" body={
