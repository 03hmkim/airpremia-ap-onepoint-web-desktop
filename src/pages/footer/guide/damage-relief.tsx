    ...
    <Container>
      ...
      <C.wrap>
        <C.body>
          ...
          <C.content>
            <C.t>1) 항공교통사업자의 운송 불이행 및 지연</C.t>
            <C.t>2) 위탁수하물의 분실 및 파손</C.t>
            <C.t>3) 항공권 초과 판매</C.t>
            <C.t>4) 취소 항공권의 대금환급 지연</C.t>
            <C.t>5) 탑승장, 항공편 등 관련 정보 미제공으로 인한 탑승 불가</C.t>
            <C.t>6) 항공사 과실로 인한 항공마일리지의 누락</C.t>
            <C.t>7) 항공사의 사전고지 없이 발생한 항공마일리지의 소멸</C.t>
            <C.t>8) 「교통약자의 이동편의 증진법」제2조 제7호에 따른 이동편의시설의 미설치로 인한 항공기의 탑승장애</C.t>
            <C.t>※단, 기상악화, 안전운항을 위한 예견하지 못한 정비, 천재지변 또는 항공기의 접속관계 등의 불가항력적인 사유로 발생한 피해는구제대상에서 제외</C.t>
          </C.content>
          ...
          <C.content>
              ...
              <T.table>
                <table>
                  ...
                  <tbody>
                    <tr>
                      <th>우편 접수</th>
                      <td>서울특별시 강서구 공항대로 248, 4층, 에어프레미아</td>
                      <th>방문 접수</th>
                      <td>서울특별시 강서구 공항대로 248, 4층, 에어프레미아</td>
                    </tr>
                  </tbody>
            ...
            <C.t1>- 공항지점 : 피해구제신청 접수</C.t1>
            <C.t1>- 예약센터 : 피해구제신청 접수 및 처리</C.t1>
          </C.content>
