...
function International(){
  return (
    <Container>
      ...
      <C.wrap>
        <C.body>
          <C.title>제 1 장 총 칙</C.title>
          <C.sub>1.1 적용범위</C.sub>
          <C.content>
        ...
        <C.body>
          <C.title>제 2 장 운송장의 작성</C.title>
          <C.sub>2.1 송하인에 의한 운송장의 작성</C.sub>
          <C.content>
          ...
          <C.sub>2.3 운송장 기재내용에 대한 책임</C.sub>
          <C.content>
          ...
          <C.sub>2.4 화물의 외양이 양호하지 않은 경우</C.sub>
          <C.content>
        ...
        <C.body>
          <C.title>제 5 장 화물의 운송</C.title>
          <C.sub>5.1 법령의 준수</C.sub>
          <C.content>
          ...
          <C.sub>5.3 운송 중의 화물에 대한 에어프레미아의 권리</C.sub>
          <C.content>
          ...
          <C.sub>5.4 운항시간, 운항노선 및 취소</C.sub>
          <C.content>
        ...
        <C.body>
          <C.title>제 6 장 송하인의 화물처분</C.title>
          <C.sub>6.1 화물처분권의 행사</C.sub>
          <C.content>
        ...
        <C.body>
          <C.title>제 7 장 화물의 인도</C.title>
          <C.sub>7.1 화물의 도착통지</C.sub>
          <C.content>
        ...
        <C.body>
          <C.title>제 9 장 집하, 배달 및 시내화물 취급 서비스</C.title>
          <C.sub>9.1 화물은 화물의 출발지에서 목적지까지의 운송을 위하여 인수된다.</C.sub>
          <C.sub>9.2 그러나 송하인 또는 수하인의 요청에 따라 에어프레미아가 집하, 배달 및 시내화물취급서비스를 행하는 경우에는 다음의 규정이 적용된다.</C.sub>
          <C.content>
          ...
          <C.sub>9.3 에어프레미아는 위 1, 2항 이외의 경우에 송하인 또는 수하인의 대리인으로서 그리고 송하인 또는 수하인의 비용부담으로 당해운송을 타 운송기관에 의뢰할 수 있다.</C.sub>
          <C.content>
        ...
        <C.body>
          <C.title>제 10 장 연결 운송편</C.title>
          <C.sub>하나의 운송장에 의하여 둘 이상의 운송인이 연결하여 행하는 운송은 단일 운송으로 간주된다.</C.sub>
        </C.body>
        <C.body>
          <C.title>제 11 장 적용협약 및 규정</C.title>
          <C.sub>11.1 적용되는 국제협약</C.sub>
          <C.content>
        ...
        <C.body>
          <C.title>제 12 장 배상책임</C.title>
          <C.sub>12.1 책임의 한도</C.sub>
          <C.content>
        ...
        <C.body>
          <C.title>제 13 장 약관의 정본</C.title>
          <C.sub>본 약관은 영문판으로 발행될 수 있으며, 이러한 경우 국문판 약관과 일치하지 않는 것이 있다면, 국문판 약관이 우선하여 적용된다.</C.sub>
