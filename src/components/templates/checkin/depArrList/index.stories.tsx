...
import DepArrListTemplate from '.';
// import {
//   TripListTable,
//   LinkBarWithImage,
...
export default {
  title: 'desktop / Templates / DepArrListTemplate',
  component: DepArrListTemplate,
...
export const 출도착조회리스트: FC = () => {
  // const [currIdx, setCurrIdx] = useState(0);
  // const tabList = ['구간조회', '편명조회', '실시간'];
  // const headerList = [
  //   '예약번호',
  //   '여정',
  //   '노선',
