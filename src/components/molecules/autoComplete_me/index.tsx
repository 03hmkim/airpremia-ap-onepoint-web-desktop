...
const AutoComplete_me: FC<IProps> = ({
  emptyMessage = '',
  dataList = {},
  label,
  selectLabel,
        ...
        <div>
            ...
            <ul className="filter">
              {map(dataList, (data, idx) => {
                ...
                return selectLabel == data.countryText && (
                  <li
            ...
            <ul className="filter">
              ...
              {map(dataList, (data, idx) => {
                ...
                console.log("selectLabel", selectLabel);//select된 값
                console.log("data", data);//총 리스트

                // focusNation.current?.focus();
                // useEffect(() =>{
                //   console.log("포커스",focusNation.current);
                //   focusNation.current?.focus();
                // },[focusNation]);
...
export default AutoComplete_me;
